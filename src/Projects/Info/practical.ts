  ...
  projects: [
    {
      ...
      media: [
        {
          type: "youtube",
          src: "https://www.youtube.com/embed/lcPMSjG6gD8?si=PYSS4F20KJ1a78qq",
          title: "touchfree",
        },
      ],
      thumbnail: { src: asset("touchfree.jpg"), alt: "" },
      links: [
        {
    ...
    },
    {
      ...
      media: [
        { src: asset("widget-instructions.avif"), alt: "" },
        { src: asset("pat-to-play.mp4"), type: "url", title: "pat-to-play" },
        {
          src: asset("point-and-scroll.mp4"),
          type: "url",
          title: "point and scroll",
        },
        { src: asset("slides.mp4"), type: "url", title: "slides" },
      ],
      thumbnail: { src: asset("widgets.jpg"), alt: "" },
      links: [
        {
    ...
    },
    {
      ...
      media: [
        {
          type: "url",
          src: asset("tapa-tapa-tapa.mp4"),
          title: "tapa-tapa-tapa",
        },
      ],
      thumbnail: { src: asset("tapa-tapa-tapa.jpg"), alt: "" },
      links: [
        {
    ...
    },
    {
      ...
      media: [{ src: asset("careers.jpg"), alt: "" }],
      thumbnail: { src: asset("careers.jpg"), alt: "" },
      links: [
    ...
    },
    {
      ...
      media: [
        { type: "url", src: asset("eviesbuttons.mp4"), title: "eviesbuttons" },
      ],
      thumbnail: { src: asset("eviesbuttons.jpg"), alt: "" },
      links: [
